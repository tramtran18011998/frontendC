                        ...
                        <div className="col-11 row" style={{ position: "relative", background: "white", border: "1px solid #00000030", marginBottom: "50px" }}>
                            <div className="col-12 mt-4">
                                    <h2 style={{ fontSize: "20px", marginLeft: "10px", color: "red" }}>
                                        <Icon size={20} onClick={() => Router.push("/writers")} style={{ marginRight: "20px", cursor: "pointer", color: "black" }} icon={ic_arrow_back} />Back Your Document</h2>
                                    <h2 style={{textAlign:"center", fontSize:"30px"}}>Add New Document</h2>
                            </div>
                            <div className="form-group col-12 row">
                                <div className="col"></div>
                                <div className="col-12 mt-3 row container">
                                    <TextField
                                        id="standard-name"
                                        label="title"
                                        name="title"
