...
class LoginPage extends Component {
    constructor(props){
        super(props)
        this.state = { username: '', password: '', valid: false, error: ''}
    ...
    render() {
        ...
        const handleLogin = () => {
            if (this.validateForm()){
                const loginUrl = `https://jsonplaceholder.typicode.com/users?username=${this.state.username}`
                fetch(loginUrl)
